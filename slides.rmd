...
### &emsp; `r icon_rocket()` What DC is doing? 
### &emsp; `r icon_rocket()` What is so special for 'game' data?
...
### &emsp;`r icon_comment()` Image any data you've handled. 
...
### &emsp;`r icon_comment()` How can you define data of any kind? 
