...
???
I told you already two points. Final one is most important but difficult to do. 
Usaually, insight is out of reach. Your analytics are ignored or changes its original meaning. 
...
If we assume that 1 Terabyte hard disk for each one, 5 Tera byte. 
...
###  `r icon_rocket()` Statistical methods are useful. 
