...
# Natural Experiment
<br>
## &thinsp;  `r icon_rocket()` With natural experiment,<br> &emsp;&emsp; We have a randomizing machine given by nature. 
## &thinsp; `r icon_rocket()` What is natural experiment for this problem?

---
# The Effect of Good Gear
<br>
## &thinsp;  `r icon_rocket()` If nature gives a player some kind of good gears, the player spends more time and/or money on the game?  
## &thinsp; `r icon_rocket()` This question is not so simple as it seems...

---
# Confounder 

## &thinsp;  `r icon_rocket()` More education &rarr; More productive &rarr; More Salery 
## &thinsp;  `r icon_rocket()` More education &rarr; More productive?
## &thinsp;  `r icon_rocket()` What if there exists a third factor affecting both (education, productivity)
...
- Use regression method to establish causlity relation 
